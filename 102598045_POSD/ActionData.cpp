...
const string ActionData::ActionName[] = {"Open...","Exit","Undo","Redo","Delete","Cut","Copy","Paste","Pointer","AddConnector","AddAttribute","AddEntity","AddRelationShip","SetPrimaryKey","About"};
...
const unsigned int ActionData::ActionLength = 15;
...
//Help
const unsigned int ActionData::About = 14;