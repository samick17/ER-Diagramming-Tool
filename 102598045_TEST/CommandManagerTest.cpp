...
void CommandManagerTest::executeCommand(){
    ...
    this->commandManager->execute(new AddNodeCommand(this->erModel.componentMap,this->attributeName));
    ...
    this->commandManager->execute(new AddNodeCommand(this->erModel.componentMap,this->relationShipHas));
...
TEST_F(CommandManagerTest,testCommandManager){
    ...
    this->commandManager->execute(new ConnectNodeCommand(this->erModel.componentMap,this->entityEngineer,this->attributeName,this->connectorEngineerName));
    ...
    this->commandManager->execute(new ConnectNodeCommand(this->erModel.componentMap,this->entityEngineer,this->relationShipHas,this->connectorHasEngineer));
    ...
    this->commandManager->execute(new AddNodeCommand(this->erModel.componentMap,this->entityPC));
    ...
    this->commandManager->execute(new ConnectNodeCommand(this->erModel.componentMap,this->entityPC,this->relationShipHas,this->connectorHasPC));
    ...
    this->commandManager->execute(new DeleteComponentCommand(this->erModel.componentMap,this->connectorEngineerName));
    ASSERT_EQ(6,this->erModel.componentMap.size());
    ...
    this->commandManager->execute(new DeleteComponentCommand(this->erModel.componentMap,this->attributeName));
    ASSERT_EQ(5,this->erModel.componentMap.size());
    ASSERT_EQ(false,this->entityEngineer->hasConnectedTo(this->attributeName));
    ASSERT_EQ(false,this->attributeName->hasConnectedTo(this->entityEngineer));
    ...
    this->commandManager->execute(new DeleteComponentCommand(this->erModel.componentMap,this->relationShipHas));
    ASSERT_EQ(4,this->erModel.componentMap.size());
    ...
    this->commandManager->execute(new DeleteComponentCommand(this->erModel.componentMap,this->entityEngineer));
    ASSERT_EQ(4,this->erModel.componentMap.size());
    ASSERT_EQ(false,this->entityEngineer->hasConnectedTo(this->relationShipHas));
    ASSERT_EQ(false,this->entityEngineer->hasConnectedTo(this->attributeName));
    ASSERT_EQ(false,this->relationShipHas->hasConnectedTo(this->entityEngineer));
...
TEST_F(CommandManagerTest,testRedoUndo){
    ...
    this->commandManager->execute(new DeleteComponentCommand(this->erModel.componentMap,this->entityPC));
    ASSERT_EQ(0,this->erModel.componentMap.size());
}
...
TEST_F(CommandManagerTest,testPopAllStack){
    ...
    this->commandManager->redoCommandsStack.push(new AddNodeCommand(this->erModel.componentMap,this->attributeName));
    this->commandManager->redoCommandsStack.push(new DeleteComponentCommand(this->erModel.componentMap,this->attributeName));
    this->commandManager->redoCommandsStack.push(new AddNodeCommand(this->erModel.componentMap,this->entityEngineer));
    this->commandManager->popAllStack();
    ASSERT_EQ(0,this->commandManager->redoCommandsStack.size());
    ASSERT_EQ(0,this->commandManager->undoCommandsStack.size());

    this->commandManager->undoCommandsStack.push(new AddNodeCommand(this->erModel.componentMap,this->relationShipHas));
    this->commandManager->undoCommandsStack.push(new AddNodeCommand(this->erModel.componentMap,this->entityPC));
    this->commandManager->popAllStack();
    ASSERT_EQ(0,this->commandManager->redoCommandsStack.size());
    ASSERT_EQ(0,this->commandManager->undoCommandsStack.size());
}